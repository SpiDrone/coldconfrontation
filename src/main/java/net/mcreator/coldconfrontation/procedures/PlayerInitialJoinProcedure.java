...
public class PlayerInitialJoinProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!ColdconfrontationModVariables.WorldVariables.get(world).hasWorldSpawnChanged) {
			...
			ColdconfrontationMod.queueServerWork(1, () -> {
				...
				ColdconfrontationModVariables.WorldVariables.get(world).hasWorldSpawnChanged = true;
				ColdconfrontationModVariables.WorldVariables.get(world).syncData(world);
