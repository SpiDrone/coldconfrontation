...
public class SpearEntityEntity extends PathfinderMob {
	...
	public static final EntityDataAccessor<Integer> DATA_strength = SynchedEntityData.defineId(SpearEntityEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<String> DATA_texture = SynchedEntityData.defineId(SpearEntityEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_damage = SynchedEntityData.defineId(SpearEntityEntity.class, EntityDataSerializers.INT);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_texture, "coldconfrontation:textures/entities/spear1.png");
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Spear");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(SpearEntityEntity.this.getId());
					return new EmptyGuiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
