package net.mcreator.coldconfrontation.world.features;
...
import net.mcreator.coldconfrontation.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, ColdconfrontationMod.MODID);
