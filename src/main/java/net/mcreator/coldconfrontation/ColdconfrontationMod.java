 ...
 *
 */
package net.mcreator.coldconfrontation;
...
@Mod("coldconfrontation")
public class ColdconfrontationMod {
	public static final Logger LOGGER = LogManager.getLogger(ColdconfrontationMod.class);
	public static final String MODID = "coldconfrontation";
