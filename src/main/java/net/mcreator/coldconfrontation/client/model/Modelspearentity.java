package net.mcreator.coldconfrontation.client.model;
...
public class Modelspearentity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("coldconfrontation", "modelspearentity"), "main");
